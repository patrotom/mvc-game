...
public class MvcGameConfig {
    ...
    public static final int CANON_MOVE_STEP = 10;
    ...
    public static final int INFO_POS_X = 20;
    public static final int INFO_POS_Y = 20;
    public static final int MAX_ENEMIES = 5;
    public static final int ENEMIES_OFFSET_X = 300;
    public static final int ENEMIES_OFFSET = 20;
